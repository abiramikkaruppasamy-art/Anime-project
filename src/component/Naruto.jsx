...
// // // Predefined anime ID and number of cards
// // const animeId = 20; // Naruto
// // const numCards = 9;

// // // Custom messages for each card
// // const narutoMessages = [
// //   "Naruto trains with Jiraiya!",
// //   "Sasuke confronts Itachi!",
// //   "The Chunin Exams begin!",
// //   "Naruto meets Gaara!",
// //   "Sakura's medical ninja skills shine!",
// //   "The Hidden Leaf Village is attacked!",
// //   "Naruto masters the Rasengan!",
// //   "Team 7 reunites!",
// //   "Kakashi reveals his past!",
// // ];
...
// //     setSelectedMessage(narutoMessages[index]);
// //     setSelectedImage(animeDataList[index] || "/assets/naruto/id-20.jpg"); // Set the card's image
...
// //           >
// //             <img
// //               src={animeDataList[index] || `/assets/naruto/id-20.jpg`}
// //               alt={`Naruto ${index + 1}`}
// //             />
// //           </div>
// //         ))}
...
//     try {
//       const response = await axios.get('https://api.jikan.moe/v4/anime?q=naruto&limit=10');
...
//         color: "#fff"
//       }}>
//         <h2 className="text-warning text-center mb-4">Naruto Anime</h2>
