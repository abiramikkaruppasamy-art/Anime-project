...
function Toradora() {
  ...
  useEffect(() => {
    const cacheKey = "Toradora_api_data";
    ...
    if (cachedData) {
      ...
      setIsLoading(false);
      console.log("Toradora used cached data");
      return;
    }
    ...
    const fetchAnimeData = async () => {
      ...
      try {
        const response = await axios.get(
          `https://api.jikan.moe/v4/anime?q=Toradora&limit=10`,
          { timeout: 10000 }
        );
        ...
        console.log("Toradora fetched images:", images);
      } catch (error) {
        console.error("Error fetching Toradora data:", error);
            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  console.log(`Toradora image failed for index ${index}`);
                }}
              />
            </div>
          ))
